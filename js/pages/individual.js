...
//     ・🐣 孵化日 + 経過日数 (色分け、親ロットからの継承にも対応)
//     ・🔄 最終マット交換日 + 経過日数 (色分け)
//     ・右端に体重 (大型表示、1.15rem 緑色太字) を表示
//     ・右端にマット種別バッジ (T0/T1/T2/T3/MD)
//     lot.js のグローバルヘルパー (_resolveHatchDate / _getLastFullExchange /
//     _formatAgeDate / _matBadgeHTML) を利用。
//   - 羽化後リマインドバッジは Phase 1-C の機能として継続
//
